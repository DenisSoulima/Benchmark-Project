...
#1000000000
NUMBER_OF_Operations = 1000000000
...
def two_threads():
    ...
    for i in range(num_of_threads):
        ...
        two_threads = threading.Thread(target=count, args=(start, end))
...
def four_threads():
    ...
    for i in range(num_of_threads):
        ...
        four_threads = threading.Thread(target=count, args=(start, end))
...
def eight_threads():
    ...
    for i in range(num_of_threads):
        ...
        eight_threads = threading.Thread(target=count, args=(start, end))
...
def sixteen_threads():
    ...
    for i in range(num_of_threads):
        ...
        sixteen_threads = threading.Thread(target=count, args=(start, end))
...
def main():
    ...
    print('Sixteen threads working...')
    trial4 = []
    for i in range(3):
        trial3.append(sixteen_threads())

    sixteen_threads_result = ((trial3[0]+ trial3[1] +trial3[2]) / 3)
    print("Sixteen threads: " + str(sixteen_threads_result/1000000000) +  " gflops")
